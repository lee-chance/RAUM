...
<br>
	...
	<form action="memberOutEnd.do?email=${list.email}" onSubmit = "return formChk();" method = "post">  
		<table class = "type09">
							<colgroup>
								<col width="15%"><col width="*">			
							</colgroup>
							<tbody>
								...
								<!--  이름을 받아오기 애매하여 닉네임으로 전환 -->
								<tr>
									<td>닉네임</td>
									<td><input type = "text" name = "name" value ="${list.nickname}" readonly = "readonly"></td> 
								</tr>
								<tr>
									<td>비밀번호</td>
