...
<table class = "type01">
	...
	<tbody>
		<tr>
			<td colspan="4"><span><input type = "text" name = "name" value = "${param.nickname}" size = 5 readonly = "readonly" style = "font-size:15px">고객님의 쇼핑함입니다. 보유 포인트를 확인하실 수 있습니다.</span> </td>
		</tr>
		<tr>
			<td>최초가입일</td>
...
<p>변경할 부분을 입력후 버튼을 눌러주세요 !</p>
		...
		<form action = "memberInfoManagement.do" method = "get" onsubmit="return Check();">
			<table class = "type09">
							<colgroup>
								<col width="15%"><col width="">
							</colgroup>
							...
							<tbody> 
								<tr>
									<td>아이디</td>
									<td><input type = "text" name = "email" readonly = "readonly" value = "${param.email}"></td>
								</tr>
								<tr>
									<td>핸드폰번호</td>
									<td>								
...
<br>
		...
		<input type="button" value="취소" onClick="location.href='userInfo.do'" style="color:red;">
		</div>
		</form>
