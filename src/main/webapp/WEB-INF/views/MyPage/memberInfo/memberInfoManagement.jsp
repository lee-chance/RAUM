...
<form action= "/ProjectShare/ViewPage/UpdateUser.jsp" method="post">	
<table class = "type01">
	<colgroup>
...
<p>고객님의 기본정보는 라움에서 안전하게 관리되고 있습니다.</p>				
			<table class = "type09">
							...
							<tbody>
								...
								<tr>
									<td>이름</td>
									<td><input type = "text" name = "name" value = "${list.name}" size = 50 readonly = "readonly" style = "font-size:15px"></td> 
								</tr>
								<tr>
									<td>핸드폰번호</td>
									<td><input type = "text" name = "phone1" value = "${phone1}" size = 10 readonly = "readonly" maxlength = "3" style = "font-size:15px">-
									<input type = "text" name = "phone2" value = "${phone2}" size = 10 readonly = "readonly" maxlength = "4" style = "font-size:15px">-
									<input type = "text" name = "phone3" value = "${phone3}" size = 10 readonly = "readonly" maxlength = "4" style = "font-size:15px">
									</td>
								</tr>
								<tr>
									<td>닉네임</td>
									<td><input type = "text" name = "nickname" value = "${list.nickname}" size = 50 readonly = "readonly" style = "font-size:15px"></td>
								</tr>
								<tr>
									<td>주소</td>
									<td><input type = "text" name = "postcode" value = "${postcode}" size = 30 readonly = "readonly" style = "font-size:15px"><br>
