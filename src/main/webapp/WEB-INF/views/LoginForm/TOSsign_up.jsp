...
<br/><br/>
<form action="/ProjectShare/signup2.do" name="form" method="post" onsubmit="return chk()">
...
-고객서비스담당 및 개인정보관리책임자 : 최종일
-전화번호 : 070-5220-0044
-이메일 : master@ddaengshop.com
...
4.경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)
  ...
  <tr>
   <td align="center" valign="top"><br><br>
    ...
    <input type="button" value="동의하지 않습니다" onClick="location.href='/ProjectShare/home.do'"/>
   </td>
  </tr>
 </table>
