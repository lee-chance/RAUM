...
<br/><br/>
<form action="SignupForm.do" name="form" method="post" onsubmit="return chk()">
 <table width="1280" height="300" align="center">
  <tr>
   <td width="100%" height="10%"><span style="padding-left: 160px">
   <img src="http://www.ddaengshop.com/common/img/sign_tit_01.gif" align="middle"></span>
   <img src="http://www.ddaengshop.com/common/img/sign_step_01.gif" align = "right">
  ...
  <h3>서비스 이용약관</h3></span>
   ...
   <br>
   <textarea rows="10" cols="130" readonly>전자상거래(인터넷사이버몰) 표준약관

표준약관 제10023호 (2010. 12. 17. 개정)

제1조(목적)

이 약관은 코질라 회사(전자상거래 사업자)가 운영하는 라움 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)

① “몰”이란 코질라 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 코질라 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위한 부서를 설치․운영합니다.
...
최종수정일 2013년 10월 01일
   ...
   <br><br>
   <input type="checkbox" name="req1" id="req1"> 라움 회원약관에 동의합니다. <br>
 
   <td align="center" valign="top">

 </table>
 
  <table width="1280" height="100" align="center">
 

  <td width="40%" height="50%" align="center">
   <span style="padding-left: 160px">
  <h3>개인정보 수집동의</h3></span>
   <br>
   <textarea
     rows="10" cols="130" readonly>개인정보취급방침

'코질라'은(는) (이하 '라움'는) 고객님의 개인정보를 중요시하며, 정보통신망이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. 라움는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 라움는 개인정보취급방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.

ο 본 방침은 : [ 2018년 10월 01일 ] 부터 시행됩니다.

□ 개인정보 수집에 대한 동의
라움는 귀하께서 라움의 개인정보보호방침 또는 이용약관의 내용에 대해 「동의한다」버튼 또는 「동의하지 않는다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의한다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.

□ 아동의 개인정보보호
ο 라움는 만14세 미만 아동의 개인정보를 수집하는 경우 법정대리인의 동의를 받습니다.
ο 만14세 미만 아동의 법정대리인은 아동의 개인정보의 열람, 정정, 동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 라움는 지체없이 필요한 조치를 취합니다.

□ 수집하는 개인정보의 항목
라움는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 휴대전화번호 , 이메일 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보 , 결제기록
ο 개인정보 수집방법 : 홈페이지(회원가입, 게시판 등) , 배송 요청

□ 개인정보의 수집 및 이용목적
라움는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 콘텐츠 제공 , 대여 및 요금 결제 , 물품대여 배송 또는 청구지 등 발송
ο 회원 관리
회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인 , 불만처리 등 민원처리 , 고지사항 전달
ο 마케팅 및 광고에 활용
이벤트 등 광고성 정보 전달 , 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
단, 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인정보(주민등록번호, 출신지 및 본적지, 정치적 성향 및 범죄기록, 건강상태 및 성생활 등)는 수집하지 않습니다.
...
□ 개인정보의 파기 절차 및 방법
라움는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.
ο 파기절차
회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다. 별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 보유되어지는 이외의 다른 목적으로 이용되지 않습니다. ο 파기방법
- 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.

□ 개인정보 제공
라움는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
- 이용자들이 사전에 동의한 경우
- 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우

□ 수집한 개인정보의 위탁
라움는 서비스 향상을 위해서 귀하의 개인정보를 외부에 위탁하여 처리할 수 있습니다.
ο 개인정보의 처리를 위탁하는 경우에는 미리 그 사실을 귀하에게 고지하겠습니다.
ο 개인정보의 처리를 위탁하는 경우에는 위탁계약 등을 통하여 서비스제공자의 개인정보보호 관련 지시엄수, 개인정보에 관한 비밀유지, 제3자 제공의 금지 및 사고시의 책임부담 등을 명확히 규정하고 당해 계약내용을 서면 또는 전자적으로 보관하겠습니다.
- 위탁 대상자 : [우체국 택배]
- 위탁업무 내용 : [물품대여 배송]
- 위탁 대상자 : [빌게이트]
- 위탁업무 내용 : [대여 및 요금 결제]
...
라움는 이용자의 요청에 의해 해지 또는 삭제된 개인정보는 “라움가 수집하는 개인정보의 보유 및 이용기간”에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.

□ 개인정보보호를 위한 기술적 대책
라움는 귀하의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적 대책을 강구하고 있습니다.
ο 귀하의 개인정보는 비밀번호에 의해 보호되며, 파일 및 전송 데이터를 암호화하거나 파일 잠금기능(Lock)을 사용하여 중요한 데이터는 별도의 보안기능을 통해 보호되고 있습니다.
ο 라움는 암호알고리즘을 이용하여 네트워크 상의 개인정보를 안전하게 전송할 수 있는 보안장치(SSL 또는 SET)를 채택하고 있습니다.
ο 해킹 등에 의해 귀하의 개인정보가 유출되는 것을 방지하기 위해, 외부로부터의 침입을 차단하는 장치를 이용하고 있으며, 각 서버마다 침입탐지시스템을 설치하여 24시간 침입을 감시하고 있습니다.

□ 개인정보 자동수집 장치의 설치ㆍ운영 및 그 거부에 관한 사항
라움는 귀하의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’ 등을 운용합니다. 쿠키란 라움의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다.
라움는 다음과 같은 목적을 위해 쿠키를 사용합니다.
...
□ 개인정보에 관한 민원서비스 라움는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.

-고객서비스담당 및 개인정보관리책임자 : 장태영
-전화번호 : 010-8736-1527
-이메일 : jty90622@gmail.com

귀하께서는 라움의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 개인정보관리책임자 혹은 담당부서로 신고하실 수 있습니다. 라움는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다.
...
4.경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)
   ...
   <br><br>
   <input type="checkbox" name="req2" id="req2"> 라움에 개인정보 수집 및 사용에 동의합니다<br>
   
  <tr>
   <td align="center" valign="top"><br><br>
	
    <input type="submit" value="동의" />&nbsp;&nbsp;&nbsp;
    <input type="button" value="동의하지 않습니다" onClick="location.href='/RAUM'"/>
   </td>
  </tr>
 </table>
