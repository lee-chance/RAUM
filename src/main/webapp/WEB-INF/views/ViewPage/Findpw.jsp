...
<div id="wrapper">
	...
	<form action="/ProjectShare/findPw.do" name="findPw" method="post" onSubmit="return checkEmpty();">
	<table border="0" align="center" style="text-align:center">
		<tr>
			<td colspan="3"><img alt="비밀번호 찾기" src="http://www.ddaengshop.com/common/img/title_pass_find.gif" width="120"></td>
		</tr>
		<tr>
			<th>아이디</th>
	...
	<table border="0" align="center" style="text-align:center">
		<tr>
		<td>해당 정보를 입력하시면 회원가입시 등록하신 <br/>
			이메일 주소로 비밀번호 정보를 안내해드립니다.</td>
		</tr>
	</table>
</div>	
</body>
