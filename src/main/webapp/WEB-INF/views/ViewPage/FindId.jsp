...
<body>
	...
	<div id="wrapper">
		...
		<form action="findId.do" name="findId" method="post"
			...
			<table border="0" name="findId" align="center"
				style="text-align: center">
				<tr>
					<td colspan="3"><img alt="login logo"
						src="http://www.ddaengshop.com/common/img/title_id_find.gif"
						width="100"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">해당 정보를 입력하시면 회원가입시 등록하신 <br /> 이메일 주소로 아이디 정보를
						안내해드립니다.
					</td>
				</tr>
			</table>
