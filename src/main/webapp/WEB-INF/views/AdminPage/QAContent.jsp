		...
		<form action="admin_qna_update.do" method="post">
			<table id="noticeTable">
				...
				<tr>
					...
					<td><input type="text" name="writeTime" size="50" value="${admin_qna_content_view.writeTime }" readonly="readonly"></td>
				</tr>	
				<tr>
				...
				<tr>
					<td colspan="2" align="center"><input type="submit" value="답변 등록">&nbsp;&nbsp;&nbsp;<a href="/RAUM/adminQAList.do">목록보기</a></td>
				</tr>				
			</table>
		</form>
</body>
