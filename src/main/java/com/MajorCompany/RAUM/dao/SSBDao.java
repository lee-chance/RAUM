...
import com.MajorCompany.RAUM.dto.SSB.CheckOutDto;
...
public interface SSBDao {
	...
	//관리자
	public ArrayList<CheckOutDto> AdminCehckOutList();
	public CheckOutInfoDto AdminCehckOutInfo(int seq);
	public void UpdateCheckOutStatus(int PAYMENTSTATUSREF_SEQ, int PAYMENT_SEQ);
	
	//메인 상품 검색
	public ArrayList<DTOProduct2> searchProduct(String search);
